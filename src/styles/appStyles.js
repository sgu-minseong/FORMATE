const appStyles = `
  * { box-sizing: border-box; }
  ...
  .items-v2-page {
    --estimate-context-pane-width: clamp(320px, 25vw, 460px);
    display: grid;
    grid-template-columns: var(--layout-local-sidebar) minmax(0, 1fr) var(--estimate-context-pane-width);
    min-height: 100dvh;
    min-width: 0;
    overflow-x: clip;
  ...
  .items-v2-page .items-v2-table {
    min-width: 0;
  }
  .items-v2-page .items-v2-table th,
  .items-v2-page .items-v2-table td {
  ...
  .estimate-context-pane__tabs button {
    position: relative;
    min-width: 52px;
    border: 0;
    padding: 0 var(--space-1);
  ...
  .estimate-context-pane__tabs button:hover {
    color: var(--color-text-primary);
  }
  .estimate-context-pane__tabs button.active {
    color: var(--color-primary);
    font-weight: var(--font-weight-semibold);
  }
  .estimate-context-pane__tabs button.active::after {
    position: absolute;
    right: var(--space-1);
    bottom: -1px;
    left: var(--space-1);
  ...
  .estimate-context-pane__tabs button:focus-visible {
    outline: none;
    box-shadow: inset 0 0 0 1px var(--color-primary-border);
  }
  .estimate-context-pane__body {
    min-width: 0;
    min-height: 0;
    flex: 1 1 auto;
  }
  .estimate-context-pane__body--estimate {
    overflow: hidden;
    background: var(--color-surface);
  }
  .estimate-live-summary {
    display: flex;
    width: 100%;
    height: 100%;
    min-width: 0;
  ...
  .estimate-live-summary__condition {
    position: sticky;
    top: 0;
    z-index: 2;
    display: grid;
  ...
  .estimate-live-summary__condition > div {
    display: grid;
    gap: 2px;
    min-width: 0;
  }
  .estimate-live-summary__condition span {
    color: var(--color-text-secondary);
    font-size: var(--font-size-caption);
    line-height: var(--line-height-caption);
  }
  .estimate-live-summary__condition strong {
    overflow: hidden;
    color: var(--color-text-primary);
    font-size: var(--font-size-body-sm);
    font-weight: var(--font-weight-semibold);
  ...
  .estimate-live-summary__edit {
    flex: 0 0 auto;
  }
  .estimate-live-summary__content {
    min-height: 0;
    flex: 1 1 auto;
    overflow-y: auto;
    overscroll-behavior: contain;
  ...
  .estimate-live-summary__groups {
    border-top: 1px solid var(--color-border);
  }
  .estimate-live-summary__group {
    padding-top: var(--space-2);
  }
  .estimate-live-summary__group h2 {
    margin: 0 0 var(--space-0-5);
    color: var(--color-text-secondary);
    font-size: var(--font-size-caption);
    font-weight: var(--font-weight-semibold);
  ...
  .estimate-live-summary__row > div {
    display: grid;
    gap: 2px;
    min-width: 0;
  }
  .estimate-live-summary__row strong {
    overflow: hidden;
    color: var(--color-text-primary);
    font-size: var(--font-size-body-sm);
    font-weight: var(--font-weight-medium);
  ...
  .estimate-live-summary__row > div > span {
    overflow: hidden;
    color: var(--color-text-muted);
    font-size: var(--font-size-caption);
    line-height: var(--line-height-caption);
  ...
  .estimate-live-summary__row .number-text,
  .estimate-live-summary__totals .number-text {
    justify-content: flex-end;
    white-space: nowrap;
    font-variant-numeric: tabular-nums;
  }
  .estimate-live-summary__footer {
    flex: 0 0 auto;
    padding: var(--space-2);
    border-top: 1px solid var(--color-border-strong);
    background: var(--color-surface);
  }
  .estimate-live-summary__totals {
    display: grid;
    gap: var(--space-1);
    margin: 0;
    padding: 0;
  }
  .estimate-live-summary__totals > div {
    display: grid;
    grid-template-columns: minmax(0, 1fr) auto;
    align-items: center;
    gap: var(--space-2);
  }
  .estimate-live-summary__totals dt,
  .estimate-live-summary__totals dd {
    margin: 0;
  }
  .estimate-live-summary__totals dt {
    color: var(--color-text-secondary);
  ...
  .estimate-live-summary__final {
    margin-top: var(--space-1);
    padding-top: var(--space-1-5);
    border-top: 1px solid var(--color-border);
  }
  .estimate-live-summary__final dt,
  .estimate-live-summary__final dd {
    color: var(--color-text-primary);
    font-weight: var(--font-weight-semibold);
  }
  .estimate-live-summary__final .number-text {
    font-weight: var(--font-weight-bold);
  }
  .estimate-live-summary__actions {
    display: flex;
    justify-content: flex-end;
    margin-top: var(--space-2);
    padding-top: var(--space-2);
  ...
  .estimate-context-pane__body--photo {
    overflow: hidden;
  }
  .estimate-context-pane__body--condition {
    display: flex;
    overflow: hidden;
  }
  .estimate-condition-content {
    display: flex;
    width: 100%;
    height: 100%;
    min-width: 0;
  ...
  .estimate-condition-content .estimate-condition-drawer__fields {
    flex: 1 1 auto;
    max-height: none;
  }
  .estimate-condition-content > .error-box {
  ...
  .formate-app-shell--estimate-preview .formate-app-shell__main {
    min-width: 0;
    padding: 0;
    overflow: hidden;
    background: var(--color-bg);
  ...
  .estimate-preview-tabs,
  .estimate-preview-header__actions {
    display: flex;
    align-items: center;
    gap: var(--space-1);
  }
  .estimate-preview-tabs button,
  .estimate-preview-header__actions button {
    min-height: 34px;
    padding: 0 12px;
    border-radius: var(--radius-button);
    font-size: var(--font-size-body-sm);
  ...
  .estimate-preview-tabs button:hover {
    background: var(--color-row-hover);
    color: var(--color-text-primary);
  }
  .estimate-preview-tabs button.active {
    background: transparent;
    color: var(--color-primary);
    font-weight: var(--font-weight-semibold);
  }
  .estimate-preview-tabs button.active::after {
    position: absolute;
    right: 10px;
    bottom: -10px;
    left: 10px;
  ...
  .estimate-preview-context strong {
    overflow: hidden;
    color: var(--color-text-secondary);
    font-weight: var(--font-weight-medium);
    text-overflow: ellipsis;
  ...
  .estimate-preview-canvas {
    min-width: 0;
    min-height: 0;
    overflow: hidden;
    background: var(--color-bg);
  }
  .estimate-document-fit {
    position: relative;
    width: 100%;
    height: 100%;
    min-width: 0;
    min-height: 0;
    overflow: hidden;
    padding: var(--space-2) 1px 46px var(--space-2);
    box-sizing: border-box;
    cursor: default;
    user-select: none;
    touch-action: none;
  }
  .estimate-document-fit.is-zoomed {
    cursor: grab;
  }
  .estimate-document-fit.is-dragging {
    cursor: grabbing;
  }
  .estimate-document-stage {
    position: absolute;
    top: 0;
    left: 0;
    display: flex;
  ...
  .estimate-preview-page-content {
    position: absolute;
    overflow: hidden;
  }
  .estimate-preview-page-source {
    position: absolute;
    left: 0;
    width: 794px;
    transform-origin: top left;
  }
  .estimate-preview-controls {
    position: absolute;
    right: 1px;
    bottom: 8px;
    left: var(--space-2);
  ...
  .estimate-preview-zoom,
  .estimate-preview-pagination {
    display: inline-flex;
    min-height: 28px;
    align-items: center;
    gap: var(--space-0-5);
  ...
  .estimate-preview-zoom span {
    min-width: 48px;
    padding: 0 var(--space-1);
    text-align: center;
  }
  .estimate-preview-zoom button,
  .estimate-preview-pagination button {
    display: inline-flex;
    min-width: 28px;
    min-height: 28px;
    align-items: center;
  ...
  .estimate-preview-zoom button:first-child {
    border-left: 0;
  }
  .estimate-preview-zoom button:hover:not(:disabled) {
    background: var(--color-row-hover);
    color: var(--color-text-primary);
  }
  .estimate-preview-zoom button:disabled {
    color: var(--color-text-muted);
    cursor: default;
    opacity: 0.56;
  }
  ...
  .estimate-preview-pagination span {
    min-width: 70px;
    text-align: center;
  }
  .estimate-preview-pagination button:disabled {
    color: var(--color-text-muted);
    cursor: not-allowed;
    opacity: 0.5;
  }
  ...
  .estimate-document-pane__header {
    display: flex;
    min-height: 64px;
    flex: 0 0 auto;
    align-items: center;
  ...
  .estimate-document-pane__header h2,
  .estimate-document-pane__header p {
    margin: 0;
  }
  .estimate-document-pane__header h2 {
    color: var(--color-text-primary);
  ...
  .estimate-document-pane__section {
    display: grid;
    gap: var(--space-1-5);
  }
  .estimate-document-pane__section h3 {
    margin: 0;
    color: var(--color-text-primary);
    font-size: var(--font-size-body-sm);
    line-height: var(--line-height-body-sm);
  }
  .estimate-document-pane__section label {
    display: grid;
    gap: 4px;
    color: var(--color-text-secondary);
    font-size: var(--font-size-caption);
  ...
  .estimate-document-pane__section input,
  .estimate-document-pane__section select {
    width: 100%;
    min-width: 0;
    min-height: 36px;
    padding: 0 10px;
  ...
  .estimate-document-pane__date-grid {
    display: grid;
    grid-template-columns: repeat(2, minmax(0, 1fr));
    gap: var(--space-1);
  }
  .estimate-document-pane__context {
    padding-top: var(--space-2);
    border-top: 1px solid var(--color-border);
  }
  .estimate-document-pane__context dl,
  .estimate-document-pane__context dl div {
    display: grid;
    gap: var(--space-1);
    margin: 0;
  }
  ...
  .estimate-document-pane__context dt,
  .estimate-document-pane__context dd {
    margin: 0;
    font-size: var(--font-size-caption);
    line-height: var(--line-height-body);
  }
  ...
  .estimate-document-pane__save-error {
    display: flex;
    align-items: center;
    justify-content: space-between;
    gap: var(--space-1);
  ...
  .estimate-document-pane__save-error button {
    flex: 0 0 auto;
  }
  .estimate-document-pane__footer {
    flex: 0 0 auto;
    padding: 12px 16px;
    border-top: 1px solid var(--color-border);
    background: var(--color-surface);
  }
  .estimate-document-pane__footer .primary-button {
    width: 100%;
    min-height: 36px;
  }
  .general-preview-panel > .editor-header,
  ...
  .estimate-customer-grid div {
    display: grid;
    grid-template-columns: 76px minmax(0, 1fr);
    gap: 8px;
    align-items: baseline;
  }
  .estimate-customer-grid span,
  .estimate-customer-grid strong {
    min-width: 0;
    font-size: var(--font-size-caption);
    line-height: var(--line-height-body-sm);
  }
  ...
  .general-estimate-document .customer-adjustment-preview,
  .detail-estimate-document .customer-adjustment-preview {
    margin-top: 10px;
  }
  .general-estimate-document .estimate-number-footer,
  ...
  .pdf-capture-area .general-estimate-table th,
  .pdf-capture-area .general-estimate-table td {
    min-width: 0;
  }
  .pdf-capture-area .general-estimate-table th:nth-child(1),
  .pdf-capture-area .general-estimate-table td:nth-child(1) {
  ...
  .sash-condition-control__label {
    color: var(--color-text-secondary);
    font-size: var(--font-size-caption);
    font-weight: var(--font-weight-medium);
    white-space: nowrap;
  }
  .sash-condition-control__help-trigger {
    width: 28px;
    height: 28px;
    color: var(--color-text-muted);
  }
  .sash-condition-control__trigger {
    width: auto;
    min-width: 92px;
    min-height: 32px;
  ...
  .sash-condition-control__trigger:hover:not(:disabled),
  .sash-condition-control__trigger[aria-expanded="true"] {
    border-color: var(--color-border-strong);
    background: var(--color-surface-subtle);
  }
  .sash-condition-control__popover,
  .sash-condition-control__help {
    right: 0;
    left: auto;
    border-color: var(--color-border-strong);
    border-radius: var(--radius-input);
  ...
  .sash-condition-control__help strong {
    color: var(--color-text-primary);
  }
  .sash-condition-control__popover--manage {
    width: 320px;
    padding: var(--space-1);
  }
  .sash-condition-control__manager,
  .sash-condition-control__manage-list {
    display: grid;
    gap: var(--space-0-5);
  }
  .sash-condition-control__manager-header,
  .sash-condition-control__create,
  .sash-condition-control__manage-row {
    display: grid;
    align-items: center;
    gap: var(--space-0-5);
  }
  ...
  .sash-condition-control__manage-row {
    grid-template-columns: 20px 16px minmax(0, 1fr) 32px;
    min-height: 32px;
    border-bottom: 1px solid var(--color-border);
  }
  .sash-condition-control__manage-row input,
  .sash-condition-control__create input,
  .sash-option-select__create input {
    width: 100%;
    min-width: 0;
    min-height: 28px;
    padding: 3px var(--space-1);
  ...
  .sash-condition-control__manage-row input:focus-visible,
  .sash-condition-control__create input:focus-visible,
  .sash-option-select__create input:focus-visible {
    border-color: var(--color-primary);
    outline: none;
  }
  .sash-condition-control__create {
  ...
  .sash-condition-control__empty,
  .sash-condition-control__error,
  .sash-option-select__error {
    padding: var(--space-1);
    color: var(--color-text-muted);
    font-size: var(--font-size-caption);
  }
  ...
  .sash-option-select__trigger {
    min-height: 32px;
    padding: 3px 6px;
    font-size: var(--font-size-table-cell);
  }
  .sash-option-select__trigger:hover:not(:disabled),
  .sash-option-select__trigger[aria-expanded="true"] {
    border-color: var(--color-border);
    background: var(--color-surface-subtle);
  }
  .sash-option-select__popover {
    position: fixed;
    z-index: 80;
    width: 196px;
  ...
  .sash-option-select__popover--manage {
    width: 320px;
    padding: var(--space-1);
  }
  .sash-option-select__popover .canonical-variant-dropdown__options {
    overscroll-behavior: contain;
  }
  .sash-option-select__popover .canonical-variant-dropdown__option.active {
    background: var(--color-surface-subtle);
  }
  .sash-option-select__create {
    display: grid;
    gap: var(--space-0-5);
  }
  .sash-option-select__manager,
  .sash-option-select__manage-list {
    display: grid;
    gap: var(--space-0-5);
  }
  .sash-option-select__manage-list {
  ...
  .sash-option-select__manage-row {
    display: grid;
    grid-template-columns: 16px minmax(0, 1fr) auto 32px;
    align-items: center;
    gap: var(--space-0-5);
    min-height: 32px;
    border-bottom: 1px solid var(--color-border);
  ...
  .sash-option-select__manage-row input {
    width: 100%;
    min-width: 0;
    min-height: 28px;
    padding: 3px var(--space-1);
  ...
  .sash-option-select__manage-row input:focus-visible {
    border-color: var(--color-primary);
    outline: none;
  }
  .sash-option-select__semantic {
    color: var(--color-text-secondary);
    font-size: var(--font-size-caption);
    white-space: nowrap;
  }
  .sash-option-select__archive:hover {
    background: var(--color-danger-bg);
    color: var(--color-danger);
  }
  .sash-option-select__footer-actions {
    display: flex;
    justify-content: space-between;
    gap: var(--space-0-5);
  }
  .sash-option-select__create-actions {
    display: flex;
    justify-content: flex-end;
    gap: var(--space-0-5);
  }
  .sash-option-select__create .ui-field,
  .sash-option-select__create .ui-select {
    width: 100%;
  }
  .sash-catalog-grid__condition {
    display: inline-grid;
    width: 28px;
    height: 28px;
    place-items: center;
  ...
  .sash-catalog-grid .ui-table th.sash-catalog-grid__icon-cell,
  .sash-catalog-grid .ui-table td.sash-catalog-grid__icon-cell {
    padding-right: 2px;
    padding-left: 2px;
    text-align: center;
  }
  .sash-catalog-grid__condition.is-selected {
    border-color: var(--color-primary-border);
    color: var(--color-primary);
  }
  .sash-catalog-grid__condition:focus-visible {
    outline: none;
    box-shadow: var(--focus-ring);
  }
  .sash-catalog-grid__condition:disabled {
    cursor: not-allowed;
    opacity: 0.35;
  }
  ...
  .sash-catalog-grid .ui-table__input:not(:focus) {
    overflow: hidden;
    text-overflow: ellipsis;
    white-space: nowrap;
  }
